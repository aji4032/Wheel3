...
public class OllamaUtility {
    ...
    public static String getSelector(String html, String query) {
        ...
        System.out.println("[OllamaUtility] Original HTML size: " + html.length()
        ...
        try {
            ...
            System.out.println("[OllamaUtility] Sending request to Ollama...");
            ...
            try (Response response = client.newCall(request).execute()) {
                ...
                System.out.println("[OllamaUtility] Got selector: " + result);
                return result;
            }
        } catch (IOException e) {
